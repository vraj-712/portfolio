/* =============================================================================
   ...
   Everything a person needs to make this portfolio their own lives in the three
   ...
   SEO metadata (title, description, Open Graph, canonical, JSON-LD) is written
   directly as static HTML in index.html — edit it there, not here.

   Assets (résumé PDF, project images) are files under /public — the config
   holds their paths, so swap the files and update the paths.
...
export const site: SiteConfig = { content, labels, theme };

// Named re-exports so existing/imports can pull just the slice they need.
export { content, labels, theme };
